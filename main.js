...
function preload()
{
  ...
  Song2=loadSound("Shivayya - Bolo Har Har.mp3");
}
...
if(scoreRW>0.2)
{
   ...
   {
    Song2.play();
    document.getElementById("song").innerHTML="Current Song:"+" Bola Har har ";
   }
}
...
if(scoreLW>0.2)
{
  ...
  if(statuslw == false)
   {
    Song1.play();
    document.getElementById("song").innerHTML="Current Song:"+" Unstoppable by Sia";
   }
}
